...
// Q12~Q15: 경험수준/서빙방식/예산/도수선호 보정 질문
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      { id: "q15-1", text: "낮을수록 편하게 마시기 좋다 (40% 내외)", meta: { abvPreference: "낮음" } },
      { id: "q15-2", text: "표준적인 도수면 충분하다 (40~43%)", meta: { abvPreference: "보통" } },
      { id: "q15-3", text: "알코올이 확실히 느껴지는 편이 좋다 (43%↑)", meta: { abvPreference: "높음" } },
    ],
  },
];
