...
> Q1~Q11(11문항)은 7개 향미 축(A~G) 점수를 쌓는 **핵심 매칭 질문**이며, Q12~Q13(2문항)은 매칭 이후 **보정 필터**로 사용되는 **보조 질문**이다. 총 13문항.
...
> 예산·도수 선호 질문은 MVP 진행 중 순차적으로 제외되었다. 가격대(`price_tier`)와 도수(`abv`)는 결과 화면 표시용 정보로만 사용한다.
