...
| 동작 | 1. 질문/선택지는 최초 진입 시 `GET /api/questions`로 로드(또는 정적 데이터, 4-3 DB 설계 참고)<br>2. 선택지 클릭 시 해당 답변을 질문 인덱스에 맞춰 로컬 상태에 저장하고 0.3초 트랜지션 후 다음 질문으로 이동<br>3. 마지막 질문(13번) 응답 시 로딩 오버레이 표시 → `POST /api/quiz/submit` 호출<br>4. 응답 성공 시 반환된 `resultId`로 `/result/[resultId]`로 이동 |
| 예외 처리 | - 새로고침 시 진행 중이던 답변은 초기화(회원 시스템 없으므로 저장하지 않음, 진입 시 안내 없이 Q1부터 재시작)<br>- `POST /api/quiz/submit` 실패 시 "결과를 계산하지 못했어요, 다시 시도해주세요" 토스트 + 재시도 버튼<br>- 13문항 중 하나라도 누락된 상태로 제출 시도 시 클라이언트에서 차단(있을 수 없는 케이스지만 방어 코드 작성) |
...
> 예산·도수 선호 질문은 MVP 진행 중 순차적으로 제외되었다. 면세점가(`priceKrw`)와 도수(`abv`)는 결과 화면 표시용 정보로만 사용한다.
...
향미 점수는 0(거의 없음)~5(매우 강함) 스케일. `하이볼적합`은 라이트 바디/블렌디드 위스키 중심으로 true 처리. **면세점가는 국내 면세점 1병 기준 참고 가격(원)이며, 실제 가격은 매장·시기에 따라 달라질 수 있다** (6-6-1 참고).

| 위스키 | 국가 | 타입 | 도수 | Peat | Sweet | Fruit | Sherry | Vanilla | Spice | Body | 난이도 | 면세점가(원) | 하이볼적합 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Glenfiddich 12 | 스코틀랜드 | 싱글몰트 | 40% | 0 | 3 | 4 | 1 | 2 | 1 | 1 | 쉬움 | 58,000 | true |
| Glenlivet 12 | 스코틀랜드 | 싱글몰트 | 40% | 0 | 2 | 4 | 1 | 2 | 1 | 1 | 쉬움 | 60,000 | true |
| Glenmorangie Original 10 | 스코틀랜드 | 싱글몰트 | 40% | 0 | 2 | 4 | 1 | 3 | 1 | 1 | 쉬움 | 62,000 | true |
| Glenmorangie Lasanta | 스코틀랜드 | 싱글몰트 | 46% | 0 | 4 | 2 | 4 | 3 | 2 | 2 | 쉬움 | 85,000 | false |
| Macallan 12 Sherry Oak | 스코틀랜드 | 싱글몰트 | 40% | 0 | 4 | 3 | 5 | 2 | 2 | 3 | 쉬움 | 165,000 | false |
| Balvenie 12 Doublewood | 스코틀랜드 | 싱글몰트 | 40% | 0 | 4 | 2 | 3 | 4 | 1 | 2 | 쉬움 | 95,000 | false |
| Aberlour 12 Double Cask | 스코틀랜드 | 싱글몰트 | 40% | 0 | 4 | 2 | 4 | 2 | 3 | 2 | 쉬움 | 78,000 | false |
| Dalmore 12 | 스코틀랜드 | 싱글몰트 | 40% | 0 | 4 | 3 | 5 | 2 | 2 | 3 | 중간 | 130,000 | false |
| Highland Park 12 | 스코틀랜드 | 싱글몰트 | 40% | 2 | 3 | 2 | 2 | 2 | 2 | 2 | 중간 | 92,000 | false |
| Bowmore 12 | 스코틀랜드 | 싱글몰트 | 40% | 3 | 3 | 3 | 2 | 2 | 1 | 2 | 중간 | 80,000 | false |
| Talisker 10 | 스코틀랜드 | 싱글몰트 | 45.8% | 3 | 1 | 1 | 1 | 1 | 4 | 4 | 중간 | 78,000 | false |
| Ardbeg 10 | 스코틀랜드 | 싱글몰트 | 46% | 5 | 1 | 3 | 0 | 1 | 2 | 3 | 도전 | 78,000 | false |
| Laphroaig 10 | 스코틀랜드 | 싱글몰트 | 40% | 5 | 0 | 1 | 0 | 0 | 2 | 4 | 도전 | 68,000 | false |
| Lagavulin 16 | 스코틀랜드 | 싱글몰트 | 43% | 5 | 2 | 1 | 3 | 1 | 2 | 4 | 도전 | 140,000 | false |
| Monkey Shoulder | 스코틀랜드 | 블렌디드몰트 | 40% | 0 | 3 | 3 | 1 | 2 | 1 | 1 | 쉬움 | 48,000 | true |
| Johnnie Walker Black | 스코틀랜드 | 블렌디드 | 40% | 2 | 3 | 2 | 2 | 2 | 2 | 2 | 쉬움 | 42,000 | true |
| Chivas Regal 12 | 스코틀랜드 | 블렌디드 | 40% | 0 | 3 | 3 | 2 | 2 | 1 | 1 | 쉬움 | 48,000 | true |
| Jameson | 아일랜드 | 블렌디드 | 40% | 0 | 2 | 3 | 1 | 2 | 1 | 1 | 쉬움 | 38,000 | true |
| Suntory Toki | 일본 | 블렌디드 | 43% | 0 | 2 | 4 | 1 | 2 | 1 | 1 | 쉬움 | 55,000 | true |
| Hibiki Harmony | 일본 | 블렌디드 | 43% | 0 | 3 | 4 | 2 | 3 | 1 | 2 | 쉬움 | 115,000 | true |
| Macallan Double Cask 12 | 스코틀랜드 | 싱글몰트 | 40% | 0 | 4 | 3 | 3 | 3 | 2 | 2 | 쉬움 | 135,000 | false |
| Glenfarclas 12 | 스코틀랜드 | 싱글몰트 | 43% | 0 | 3 | 2 | 4 | 2 | 3 | 3 | 중간 | 85,000 | false |
| BenRiach The Twelve | 스코틀랜드 | 싱글몰트 | 43% | 0 | 3 | 4 | 2 | 3 | 2 | 2 | 쉬움 | 68,000 | true |
| Auchentoshan 12 | 스코틀랜드 | 싱글몰트 | 40% | 0 | 2 | 3 | 1 | 3 | 1 | 1 | 쉬움 | 58,000 | true |
| Springbank 10 | 스코틀랜드 | 싱글몰트 | 46% | 2 | 2 | 3 | 1 | 1 | 2 | 3 | 중간 | 120,000 | false |
| Johnnie Walker Green Label 15 | 스코틀랜드 | 블렌디드몰트 | 43% | 3 | 2 | 3 | 1 | 2 | 2 | 3 | 중간 | 95,000 | false |
| Kavalan Classic | 대만 | 싱글몰트 | 40% | 0 | 4 | 5 | 1 | 4 | 1 | 2 | 쉬움 | 68,000 | true |
| Yamazaki 12 | 일본 | 싱글몰트 | 43% | 0 | 3 | 4 | 2 | 3 | 2 | 2 | 쉬움 | 260,000 | true |
| Nikka From The Barrel | 일본 | 블렌디드 | 51.4% | 1 | 3 | 3 | 2 | 2 | 3 | 4 | 중간 | 58,000 | true |
| Woodford Reserve | 미국 | 버번 | 43.2% | 0 | 4 | 2 | 2 | 4 | 3 | 3 | 쉬움 | 55,000 | true |
| GlenDronach 12 | 스코틀랜드 | 싱글몰트 | 43% | 0 | 4 | 2 | 5 | 1 | 2 | 3 | 중간 | 115,000 | false |
| Oban 14 | 스코틀랜드 | 싱글몰트 | 43% | 1 | 2 | 3 | 1 | 2 | 2 | 2 | 중간 | 135,000 | false |
| Bunnahabhain 12 | 스코틀랜드 | 싱글몰트 | 46.3% | 0 | 2 | 2 | 2 | 1 | 1 | 2 | 쉬움 | 78,000 | false |
| Old Pulteney 12 | 스코틀랜드 | 싱글몰트 | 40% | 1 | 2 | 3 | 1 | 2 | 1 | 2 | 중간 | 85,000 | false |
| Glenkinchie 12 | 스코틀랜드 | 싱글몰트 | 43% | 0 | 2 | 3 | 1 | 2 | 1 | 1 | 쉬움 | 62,000 | true |
| Buffalo Trace | 미국 | 버번 | 40% | 0 | 4 | 1 | 1 | 4 | 2 | 2 | 쉬움 | 42,000 | true |
| Maker's Mark | 미국 | 버번 | 45% | 0 | 4 | 1 | 1 | 4 | 1 | 2 | 쉬움 | 48,000 | true |
| Wild Turkey 101 | 미국 | 버번 | 50.5% | 0 | 3 | 1 | 1 | 3 | 4 | 4 | 중간 | 50,000 | true |
| Four Roses Small Batch | 미국 | 버번 | 45% | 0 | 3 | 4 | 1 | 2 | 2 | 2 | 쉬움 | 55,000 | true |
| Jim Beam White | 미국 | 버번 | 40% | 0 | 3 | 1 | 1 | 3 | 2 | 1 | 쉬움 | 32,000 | true |

### 6-6-1. 가격 데이터의 한계와 실시간 반영 검토

- 위 가격은 2026-07 시점 웹 조사 및 일반 시세를 바탕으로 한 **참고용 추정치**이며, 실제 면세점 판매가와 다를 수 있다. 특히 야마자키 12, 히비키 하모니처럼 수요가 몰리는 일본 위스키는 재고 상황에 따라 변동 폭이 크다.
- **완전한 실시간 연동은 MVP 범위에서 권장하지 않는다.** 신라·롯데·신세계 등 국내 면세점은 공개 가격 API를 제공하지 않고, 여권/탑승권 인증 세션 뒤에 가격이 노출되는 경우가 많아 크롤링으로 안정적으로 가져오기 어렵고, 각 사이트 이용약관 위반 소지도 있다.
- 대안으로 다음을 제안한다.
  1. **주기적 수동 갱신(권장)**: `priceKrw`에 `priceUpdatedAt` 같은 갱신일 필드를 추가해, 분기 단위로 각 면세점 사이트를 직접 확인하고 갱신한다.
...
| 타입 | 싱글몰트 |
| 입문 난이도 | ★☆☆ (쉬움) |
| 가격대 | 165,000원 (면세점 기준, 매장/시기에 따라 변동) |
...
| price_krw | int | not null | 국내 면세점 1병 기준 참고 가격(원) |
...
| --- | --- | --- | --- | --- |
| GET | `/api/questions` | 활성화된 질문 13개 + 선택지 조회 | - | `{ questions: [{ id, order_no, axis, question_text, options: [{id, option_text, axis_scores}] }] }` |
...
- 이전 질문으로 돌아가 답변 수정
- 다크모드
- 가격대 필터 결과 내 별도 표시(예: "10만원 이하 위스키만 다시 보기")
...
| 위스키 검색/탐색 | 향미 축 필터로 전체 40종+ 위스키를 직접 탐색하는 카탈로그 페이지 |
